...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        chunky: "4px 4px 0 #1a1a2e",
        "chunky-sm": "3px 3px 0 #1a1a2e",
        "chunky-lg": "6px 6px 0 #1a1a2e",
        "chunky-xl": "8px 8px 0 #1a1a2e",
        "chunky-purple": "4px 4px 0 #6C5CE7",
        "chunky-teal": "4px 4px 0 #00D9C0",
        "chunky-yellow": "4px 4px 0 #FFD93D",
        "chunky-coral": "4px 4px 0 #7E22CE",
        "chunky-pink": "4px 4px 0 #FF85A2",
        "chunky-green": "4px 4px 0 #2ECC71",
        "chunky-orange": "4px 4px 0 #FF9F43",
        "chunky-blue": "4px 4px 0 #54A0FF",
      },
      borderRadius: {
        chunky: "1rem",
      },
